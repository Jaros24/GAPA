void Mg20_test_sim_pag(Int_t nEvents = 100, TString mcEngine = "TGeant4")
{

  TString dir = getenv("VMCWORKDIR");


  TString outFile ="./data/gadgetsim.root"; // Output file name

  TString parFile="./data/gadgetpar.root"; // Parameter file name
...
decay->SetDecayChainPoint(0.001210, 1); // P0 E0
decay->SetDecayChainPoint(0.000506,1); // P1 E1
//decay->SetDecayChainPoint(0.004033,0.284);//gamma

 

 decay->SetBoxXYZ(0.0,0.0,10.0,0.0,0.0,40.0); // bounds
