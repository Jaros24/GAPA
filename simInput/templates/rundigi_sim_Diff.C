void rundigi_sim_Diff(
   TString mcFile = "/mnt/analysis/e17023/Adam/ATTPCROOTv2/macro/Simulation/Charge_Dispersion/data/gadgetsim.root", // gadgetsim root file
   TString mapParFile =
   ...
   TString trigParFile = "/mnt/simulations/attpcroot/fair_install_2020/yassid/ATTPCROOTv2/parameters/AT.trigger.par")
{
   ...
   auto *wHDF = new AtHDF5WriteTask("output.h5", "AtEventH");
